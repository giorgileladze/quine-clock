...
l.h(o,+y));t=my.split("&")[j].split(s);t.forEach((_,k)=>+k%2==0?l.v(o,t[k],t[k+1]):0)});y=y?.replace
(/\s/g,s);i=0;while(i<y?.length){if(ci[i])s+=p+"38;5;27m"+y[i]+p+"0m";else s+=p+"38;5;244m"+
p+"2m"+y[i]+p+"0m";i++;if(i%q==0)s+=" ";if(i%(q*2)==0)[20,22,26,28,44,46,50,52].indexOf(i/q)
>-1?s+=`${p}38;5;${z?"27m":`244m${p}2m`}## ${p}0m`:s+="   ";if(i%(q*6)==0)s+="\n";};setTimeout(()=>{console.clear();f(f+"f()",!z)},1000);console.log(s);};f()
